        ...
        <nav className="glassmorphism bg-gradient-to-r from-indigo-50/80 via-purple-50/80 to-pink-50/80 backdrop-blur-md rounded-2xl px-6 py-4 mx-auto max-w-7xl border border-white/20">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <div className="text-xl font-bold text-white">RactorIX</div>
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <a href="#" className="text-white hover:text-indigo-400 transition-colors">Blog</a>
              <a href="#" className="text-indigo-400 hover:text-indigo-300 transition-colors">Sign In</a>
            </div>
