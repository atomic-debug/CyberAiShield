        ...
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-6">
              The everything app for cybersecurity. One platform to secure, automate, and manage.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-600">
              <li><a href="#" className="hover:text-gray-900">Threat Response</a></li>
              <li><a href="#" className="hover:text-gray-900">Compliance</a></li>
              <li><a href="#" className="hover:text-gray-900">Monitoring</a></li>
              <li><a href="#" className="hover:text-gray-900">Automation</a></li>
              <li><a href="#" className="hover:text-gray-900">AI Security</a></li>
            </ul>
          </div>
