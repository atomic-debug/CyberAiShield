...
export default function Contact() {
  return (
    <section id="contact" className="py-1 sm:py-1 md:py-2 lg:py-2 bg-gray-50">
      <div className="max-w-7xl mx-auto px-2 sm:px-3 md:px-4 lg:px-6 xl:px-8">
        <div className="bg-white rounded-2xl sm:rounded-3xl p-3 sm:p-4 md:p-5 lg:p-6 xl:p-7 shadow-lg border border-gray-200 text-center max-w-5xl mx-auto">
