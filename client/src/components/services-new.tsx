...
export default function Services() {
  ...
  return (
    <section ref={sectionRef} id="services" className="py-12 px-4 scroll-offset relative max-w-4xl mx-auto text-center">
      ...
      <div 
        className="border-l-4 border-purple-600 pl-8 py-4 rounded-l-xl bg-white/50 backdrop-blur-sm relative text-left"
